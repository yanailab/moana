...
This repository contains a Python implementation of *Moana* (Multi-resolution transcriptOmic ANAlysis framework), a framework for defining and predicting cell types in single-cell RNA-Seq data ([Wagner and Yanai, 2018](https://www.biorxiv.org/content/early/2018/10/30/456129)).
